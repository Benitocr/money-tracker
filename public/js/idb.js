...
let db;
// establish a connection to IndexedDB database called 'new_data' and set it to version 1
const request = indexedDB.open('new_data', 1);
...
function saveRecord(record) {
    ...
    const newObjectStore = transaction.objectStore('new_data');
